...
def classify(training, testing, HIDDEN_NEURONS, MOMENTUM, WEIGHTDECAY,
    ...
    fnn = buildNetwork(trndata.indim, HIDDEN_NEURONS,HIDDEN_NEURONS-10,HIDDEN_NEURONS-20, trndata.outdim,
                       outclass=SoftmaxLayer,hiddenclass=TanhLayer)
...
if __name__ == '__main__':
    ...
    net=classify(training, testing, args.hidden_neurons, args.momentum,
             args.weightdecay, args.learning_rate, args.lrdecay, args.epochs)
    NetworkWriter.writeToFile(net, 'net1.xml')